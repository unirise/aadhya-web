...
describe('Home Page', () => {
    ...
    it('renders the quick stats section', () => {
        ...
        expect(screen.getByText(/statistics will appear here when you connect your api/i)).toBeInTheDocument()
    })
    ...
    it('renders the data visualization section', () => {
        ...
        expect(screen.getByText(/charts will appear here when you add your data/i)).toBeInTheDocument()
    })

    it('has proper layout and styling', () => {
        render(<Home />)

        const mainContainer = screen.getByRole('heading', { name: /home/i }).closest('div')
