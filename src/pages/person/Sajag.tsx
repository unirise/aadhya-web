          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  Comprehensive assessment report based on multiple intelligence
                  analysis
                </p>
              </div>
            </div>
          ...
          >
            ...
            >
              <div>
                ...
                >
                  Comprehensive mapping of identified skills to available
              ...
              >
                ...
                <tbody>
                  {skillsVocationalMapping
                    .sort(
                      (a, b) =>
                        b.vocationalPaths.length - a.vocationalPaths.length
                    )
                    .map((item, _index) => (
                      <tr
                        key={item.skill}
            ...
            >
              ...
              >
                <BarChart3 size={16} />
                <span>
                  <strong>Total Skills Analyzed:</strong>{' '}
          ...
          >
            ...
            >
              <div>
                ...
                >
                  Detailed breakdown of career roles aligned with each
                  intelligence domain
                </p>
              </div>
            </div>
          ...
          >
            ...
            >
              <div>
                ...
                >
                  Career opportunities derived from combined intelligence
                  strengths
                </p>
              </div>
            </div>
          ...
          >
            ...
            >
              <div>
                ...
                >
                  Recommended training modalities and accessibility
                  considerations
                </p>
              </div>
            </div>
          ...
          >
            ...
            >
              <div>
                ...
                >
                  National Skills Qualification Framework (NSQF) - Distribution
                  of roles across qualification levels
                </p>
              </div>
            </div>
                  ...
                  {Object.entries(nsqfRolesByIntelligence).map(
                    ([intelligence, roles]) => {
                      const IconComponent = getIntelligenceIcon(
                        Object.keys(intelligenceScores || {}).find(domain =>
                          getDomainDisplayName(domain).includes(intelligence)
                        ) || ''
                      )
                      return (
                        <div
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {Object.values(rolesByIntelligence).reduce(
                  (sum, roles) => sum + (roles?.length || 0),
                  0
                )}
              </div>
              <div
