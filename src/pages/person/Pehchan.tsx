...
function Pehchan() {
  ...
  const _intelligenceSkillMapping = useMemo(() => {
    if (!intelligenceScores) return []
        ...
        >
          ...
          >
            ...
            <div>
              ...
              >
                Discover how you learn best and what teaching styles work for
                you
              </p>
            </div>
          </div>
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      padding: '24px',
                      border:
                        index === 0 ? '3px solid #3b82f6' : '2px solid #e5e7eb',
                      position: 'relative',
                    }}
                  >
                    {index === 0 && (
          ...
          >
            ...
            >
              <div>
                ...
                >
                  Teaching approaches that work best for this learner based on
                  their top strengths
                </p>
              </div>
            </div>
