...
export const generateSampleData = (type = 'line', count = 7) => {
    ...
    switch (type) {
        ...
        case 'pie':
            return [
                { name: 'Desktop', value: Math.floor(Math.random() * 30) + 30, color: CHART_COLORS.primary },
                { name: 'Mobile', value: Math.floor(Math.random() * 25) + 25, color: CHART_COLORS.secondary },
                { name: 'Tablet', value: Math.floor(Math.random() * 20) + 10, color: CHART_COLORS.accent },
                { name: 'Other', value: Math.floor(Math.random() * 15) + 5, color: CHART_COLORS.danger },
            ]
