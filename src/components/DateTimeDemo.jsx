    ...
    return (
        <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
            ...
            <p style={{ color: '#6b7280', marginBottom: '32px' }}>
                Interactive demonstration of Day.js date formatting and manipulation features
            </p>
            ...
            <div style={{
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '12px' }}>
                    <div>
                        <strong>Short Format:</strong> {formatDate(selectedDate, DATE_FORMATS.SHORT)}
                    </div>
                    <div>
                        <strong>Medium Format:</strong> {formatDate(selectedDate, DATE_FORMATS.MEDIUM)}
                    </div>
                    <div>
                        <strong>Long Format:</strong> {formatDate(selectedDate, DATE_FORMATS.LONG)}
                    </div>
                    <div>
                        <strong>ISO Format:</strong> {formatDate(selectedDate, DATE_FORMATS.ISO)}
                    </div>
                    <div>
